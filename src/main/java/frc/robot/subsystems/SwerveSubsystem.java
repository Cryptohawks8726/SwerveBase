...
public class SwerveSubsystem extends SubsystemBase {
   ...
   */
  public FunctionalCommand driveToPose8726(Pose2d desiredPose) {
    return new FunctionalCommand(
        ...
        () -> {
          ...
          double rError = calculateAbsoluteRotationError();

          return xError < SwerveConstants.translationalErrorRange && yError < SwerveConstants.translationalErrorRange
              && rError < SwerveConstants.rotationalErrorRange;

        }, this);
  }

  // Yucky hacky solution remove this later.
  public void startDriveToPose(Pose2d desiredPose) {
    swerveXPositionPID.reset();
    swerveYPositionPID.reset();
    swerveThetaPositionPID.reset();
    swerveXPositionPID.setSetpoint(desiredPose.getX());
